...
// let getNums = () => {
//     let myObj = document.getElementsByClassName("bars")
...
//     for (let i = 0; i < 10; i++) {
//         let val = randomIntFromInterval(5, 700)
//         let el = document.createElement("div")
//         el.classList.add("bars")
//         el.style.height = `${val}px`
//         el.style.backgroundColor = "pink"
//         el.setAttribute("id", `${val}`)
//         document.getElementById("uniqueBox").appendChild(el)
...
//         let firstItem = document.getElementById(`${arrayLeft[0]}`)
//         let secondItem = document.getElementById(`${arrayRight[0]}`)
...
//             let val = arrayRight.shift()
//             aux.push(val)

//             firstItem.style.height = `${val}px`
//             firstItem.style.backgroundColor = "pink"
//             firstItem.id = `${val}`

//             secondItem.style.height = `${arrayLeft[0]}px`
//             secondItem.style.backgroundColor = "pink"
//             secondItem.id = `${arrayLeft[0]}`
            
//         } else {
//             let val = arrayLeft.shift()
//             aux.push(val)

//             firstItem.style.height = `${arrayRight[0]}px`
//             firstItem.style.backgroundColor = "pink"
//             firstItem.id = `${arrayRight[0]}`
            

//             secondItem.style.height = `${val}px`
//             secondItem.style.backgroundColor = "pink"
//             secondItem.id = `${val}`
//         }
...
// // sleep function to pause JavaScript execution
